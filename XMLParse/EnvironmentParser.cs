...
public class EnvironmentParser
{
	...
	public Environment Parse(XmlDocument doc, XmlNamespaceManager nsman)
	{
		...
		e.status = UtilSingleTextNodeContentOr(nEnv, "ns:status",nsman, ""); // TODO: bail on missing status?
        ...
        foreach (XmlNode nDS in nEnv.SelectNodes("ns:data", nsman))
        {
			...
			if(nDSCurrentVal!=null){
				...
				ds.currentValueTimestamp = UtilAttribOr(nDSCurrentVal, "at", ""); //TODO: parse timestamp?
			}
